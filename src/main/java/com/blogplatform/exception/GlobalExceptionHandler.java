...
import com.blogplatform.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        ...
        return build(HttpStatus.CONFLICT, "The request violates a data integrity constraint (e.g. duplicate value)", req, null);
    }
